...
public class MinMaxOpening {
	...
	public static void main(String[] args)  {
		...
		MinMaxOpening game = new MinMaxOpening();
	...
	public Node MaxMin(Node node,int depth)
	{
		...
		List<Board> list = moveGeneratorWhite.generateMovesOpening(node.board);
	...
	public Node MinMax(Node node,int depth)
	{
		...
		List<Board> list = moveGeneratorBlack.generateMovesOpening(node.board);
